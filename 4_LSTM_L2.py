...
# heatmap.get_figure().savefig('results/lorenz96_conditional_LSTM_L2_0.01_wilcoxon.eps')
heatmap.get_figure().savefig('results/indexes_conditional_LSTM_L2_0.01_wilcoxon.eps')
plt.close(fig)
