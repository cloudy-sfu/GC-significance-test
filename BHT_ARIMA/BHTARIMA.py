...
class BHTARIMA(TransformerMixin):
    ...
    def transform(self, x, *args, **kwargs):
        ...
        trans_data, mdt = self._forward_MDT(x, [x.shape[0], self._taus[1]])
        ...
        # inverse MDT 
        result = self._inverse_MDT(mdt, mdt_result, [x.shape[0], self._taus[1]], fore_shape)
