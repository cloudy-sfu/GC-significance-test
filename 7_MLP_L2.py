...
heatmap.get_figure().savefig('results/indexes_conditional_MLP_L2_0.1_wilcoxon.svg')
# heatmap.get_figure().savefig('results/lorenz96_conditional_MLP_L2_0.1_wilcoxon.svg')
plt.close(fig)
